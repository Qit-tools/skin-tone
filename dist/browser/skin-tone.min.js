var skinTone=function(){"use strict";
/**
     ...
     */return function(i,e){if(!e)return i;var r={none:"",light:"🏻",mediumLight:"🏼",medium:"🏽",mediumDark:"🏾",dark:"🏿"},n="‍";return i.includes("‍🤝‍")&&(n="‍🤝‍"),i.split(n).map((function(i){var n=i.replace(/\p{Emoji_Modifier}/gu,"");return/\p{Emoji_Modifier_Base}/u.test(n)?n.replace(/(\p{Extended_Pictographic}+)(\uFE0F?)/u,"$1".concat(r[e])):i})).join(n)}}();
//# sourceMappingURL=skin-tone.min.js.map
